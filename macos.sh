...
# Use list view in all Finder windows by default "Nlsv"
...
defaults write com.googlecode.iterm2.plist PrefsCustomFolder -string "$HOME/Dropbox (Personal)/iterm_nightly"
